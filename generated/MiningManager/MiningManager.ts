...
export class MiningManager__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class MiningManager__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class MiningManager extends ethereum.SmartContract {
  static bind(address: Address): MiningManager {
    return new MiningManager("MiningManager", address);
  }
  ...
  pendingDefiGold(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingDefiGold",
      "pendingDefiGold(uint256,address):(uint256)",
      [
  ...
  try_pendingDefiGold(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingDefiGold",
      "pendingDefiGold(uint256,address):(uint256)",
      [
  ...
  poolInfo(param0: BigInt): MiningManager__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new MiningManager__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<MiningManager__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new MiningManager__poolInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  dgld(): Address {
    let result = super.call("dgld", "dgld():(address)", []);

    return result[0].toAddress();
  }

  try_dgld(): ethereum.CallResult<Address> {
    let result = super.tryCall("dgld", "dgld():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  dgldPerBlock(): BigInt {
    let result = super.call("dgldPerBlock", "dgldPerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_dgldPerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "dgldPerBlock",
      "dgldPerBlock():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  userInfo(param0: BigInt, param1: Address): MiningManager__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new MiningManager__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<MiningManager__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MiningManager__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
